...
namespace GasStationRatingSystem.DAL
{
    ...
    public class Repository<T> : IRepository<T> where T : class
    {
        ...
        public GasStationRatingSystemContext _db;
        private readonly IUnitOfWork<GasStationRatingSystemContext> _uow;
        ...
        public Repository(IUnitOfWork<GasStationRatingSystemContext> unitOfWork, IHttpContextAccessor httpContext, IConfiguration configuration)
        {
