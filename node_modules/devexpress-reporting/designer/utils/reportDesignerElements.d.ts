/**
* DevExpress HTML/JS Reporting (designer\utils\reportDesignerElements.d.ts)
* Version:  20.2.4
* Build date: Dec 2, 2020
* Copyright (c) 2012 - 2020 Developer Express Inc. ALL RIGHTS RESERVED
* License: https://www.devexpress.com/Support/EULAs/universal.xml
*/
export declare var ReportDesignerElements: {
    MenuButton: string;
    Toolbar: string;
    Toolbox: string;
    Surface: string;
...
export declare var ReportDesignerAddOns: {
    Preview: string;
    ReportWizard: string;
