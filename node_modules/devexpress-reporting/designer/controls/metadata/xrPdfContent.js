...
exports.pdfContentSerializationInfo = [exports.pdfSource, exports.pdfSourceUrl, scriptMetadata_1.pdfContentScripts, dataBinding_1.dataBindings(['Bookmark', 'Source', 'SourceUrl'])].concat(metadataGroups_1.sizeLocation, metadataGroups_1.baseControlProperties, metadataGroups_1.bookmarkGroup, [metadata_1.tag]);
exports.popularPropertiesPdfContent = ['name', 'source', 'sourceUrl'];
