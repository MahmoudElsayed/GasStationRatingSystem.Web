...
exports.createPopularBindingInfo = function (options, isExpression) {
    ...
    var newInfo = {
        ...
        editor: isExpression ? editorTemplates_1.designerEditorTemplates.getEditor('reportexpression') : editorTemplates_1.designerEditorTemplates.getEditor('dataBinding'),
    };
    if (isExpression)
