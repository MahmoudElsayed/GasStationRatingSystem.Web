...
ko.bindingHandlers['ruler'] = {
    init: function (element, valueAccessor) {
        ...
        }, rulerViewModel = new RulerViewModel(options), templateHtml = analytics_widgets_internal_1.getTemplate('dxrd-ruler' + options.direction), $element = $(element).append(templateHtml);
