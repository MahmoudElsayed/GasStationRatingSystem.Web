...
ko.bindingHandlers['coordinateGrid'] = {
    init: function (element, valueAccessor) {
        ...
        var values = valueAccessor(), gridViewModel = new CoordinateGridViewModel(values), templateHtml = analytics_widgets_internal_1.getTemplate('dxrd-coordinategrid'), $element = $(element).append(templateHtml);
