...
function replaceImports(fileName) {
...
function processFiles(dirname) {
    fs.readdirSync(dirname).forEach(function(filename) {
        ...
        if(stat.isDirectory()) {
            processFiles(currentFilePath)
        } else if(path.extname(currentFilePath) === ".ts") {
            replaceImports(currentFilePath);
        }
    });
}

processFiles(programArgs[0]);