...
</script>﻿<script type="text/html" id="dxrp-mobile-editing-field-image">
    <div class="dxrp-editing-field-container" data-bind="style: containerStyle() ">
        <div data-bind="dxclick: activateEditor, css: parentPopupClass">
            <div class="dxrp-editing-field-popup-container-cloned" data-bind="dxPainter: $data.getPainter()"></div>
            <!-- ko template: { name: 'dx-picture-editing-mobile', data: $data.getPopupData() } -->
            <!-- /ko -->
        </div>
    </div>
</script>

<script type="text/html" id="dx-picture-editing-mobile">
...
<script type="text/html" id="dxrd-preview-export-to">
    <div class="dxrd-preview-export-toolbar-item dxrd-toolbar-item" data-bind="visible: visible">
        <div class="dxrd-preview-export-to dxd-button-back-color dxd-state-normal dxd-back-highlighted" data-bind="dxMenu: { disabled: $data.disabled(), items: items, cssClass: 'dxrdp-export-to-menu', onItemClick: clickAction, onSubmenuShowing: function(e) { e.submenu._overlay.option('container', $root.getPopupContainer($element)) } }, attr: { title: $root.getLocalization(text, $data.textId) }">
            <div class="dxrd-preview-export-menu-item" data-options="dxTemplate: { name: 'item' }" data-bind="attr: { title: $root.getLocalization(text, $data.textId) }">
                <!--ko if: $data.format -->
                <div class="dxrd-preview-export-item-text" data-bind="text: $root.getLocalization($data.text, $data.textId)"></div>
                <!-- /ko -->
...
<script type="text/html" id="dxrd-preview-page">
    ...
    <div class="dxrd-toolbar-item-zoom" data-bind="visible: visible">
        <div class="dxrd-toolbar-item-zoom-editor" data-bind="dxSelectBox: { items: zoomItems, value: $data.zoom, displayExpr: displayExpr, displayCustomValue: true, acceptCustomValue: true, onCustomItemCreating: onCustomItemCreating, dropDownOptions: { container: $root.getPopupContainer($element) } }"></div>
    </div>
</script>
...
<script type="text/html" id="dxrd-preview-search">
    <div class="dxrd-preview-search-wrapper" data-bind="visible: active() && visible()">
        ...
        <div class="dxrd-preview-search-result-header dxd-border-primary">
            <div class="dxrd-preview-search-result-header-text" data-bind="text: $root.getLocalization('Search result', 'ASPxReportsStringId.WebDocumentViewer_SearchResultText')"></div>
        </div>
        <div class="dxrd-preview-search-result" data-bind="dxScrollView: { showScrollbar: 'onHover' }">
            <!-- ko foreach: searchResult -->
            <div class="dxrd-preview-search-result-item dxd-list-item-back-color dxd-back-highlighted" data-bind="dxclick: function() { $parent.goToResult($data); }">
                <div class="dxrd-preview-search-tab-item-text propertygrid-editor-displayName dxd-text-primary" data-bind="text: text"></div>
                <div class="dxrd-preview-search-tab-item-info" data-bind="text: $root.dx._static.formatSearchResult($data)"></div>
            </div>
            <!-- /ko -->
...
<script type="text/html" id="dxrd-preview-progress-bar">
    <div class="dxrd-preview-progress dxd-popup-back-color dxd-back-primary2 dxd-border-primary" data-bind="visible: visible, css: $data.cssClasses">
        ...
        <div class="dxrd-preview-progress-cancel dxd-hyperlink-color dxd-border-accented dxd-text-accented" data-bind="text: cancelText, dxclick: function() { $data.stop && stop(); }"></div>
    </div>
</script>
...
<script type="text/html" id="dxrd-preview-pager">
    <div class="dxrd-preview-pager dxrd-toolbar-item" data-bind="visible: visible">
        <div class="dxrd-preview-pager-selectbox" data-bind="dxSelectBox: { dataSource: pageItems, value: selectedItem, opened: opened, displayExpr: displayExpr, onFocusOut: focusOut, onKeyUp: keyUp, itemTemplate: itemTemplate, searchMode: searchMode, searchEnabled: searchEnabled, searchTimeout: searchTimeout, disabled: disabled, dropDownOptions: { container: $root.getPopupContainer($element) } }"></div>
        <div class="dxrd-toolbar-item-separator dxd-toolbar-separator-color dxd-border-secondary" data-bind="visible: $data.hasSeparator"></div>
    </div>
</script>
...
<script type="text/html" id="dxrdp-surface">
    <div class="dxrd-preview-wrapper" data-bind="textCopier, css: { 'dx-rtl': $data.rtlReport, 'dxrp-editing-fields-hightlighted': editingFieldsHighlighted } ">
        ...
        <!-- /ko -->
        <!-- /ko -->
        <div class="dxrd-preview-surface">
    ...
    <div class="dxrv-daterange-editor">
        <div data-bind="cacheElement: { action: function(element) { $data._$element = element; } }, dxEllipsisEditor: { value: _displayText, readOnly:true, openOnFieldClick: true, buttonAction: function() { $data._showPopup(); } }"></div>
...
<script type="text/html" id="dxrv-daterange-editor-popup">
    <div data-bind="dxPopup: {
        ...
        <div data-bind="dxScrollView: { showScrollbar: 'always', direction: 'horizontal', useNative: false }">
            <div class="dxrv-daterange-editor-popup-container">
                <div class="dxrv-daterange-editor-list dxrv-daterange-editor-item dxd-border-primary" data-bind="dxScrollView: { showScrollbar: 'onHover', scrollByContent: false, bounceEnabled: false, useNative: false, scrollByThumb: true }">
                    <!-- ko foreach: items -->
                    <div class="dxrv-daterange-editor-list-item dxd-state-normal dxd-back-highlighted" data-bind="css: { 'dxd-state-selected': $parent._isSelected($data) }, text: displayName, dxclick: function() { $parent.applyDate($data.range(), true) }"></div>
                    <!-- /ko -->
                </div>
...
<script type="text/html" id="dxrv-daterange-calendar">
    <div data-bind="dxCalendar: { value: value, cellTemplate: 'select_cell', height: '100%', min: min }">
...
<script type="text/html" id="dx-picture-editing-imagespicker">
    ...
    <div data-bind="dxSelectBox: getOptions({ dataSource: values, value: value, valueExpr: 'value', displayExpr: 'displayValue', displayCustomValue: true, disabled: disabled, dropDownOptions: { container: $root.getPopupContainer($element) } }), dxValidator: { validationRules: $data.validationRules || [] }"></div>
</script>
...
<script type="text/html" id="dxrd-localization-editor">
    ...
    <div class="dxrd-localization-editor dx-editors" data-bind="css: { 'dx-rtl': $root.rtl, 'dx-ltr': !$root.rtl }, styleunit: { width: width }">
        <div class="dxrd-left-localization-panel dx-editors dxd-text-primary dxd-back-primary" data-bind="resizable: getResizableOptions($element, '0px', 500, $root.rtl ? 'Left': 'Right', 'Right', width)">
