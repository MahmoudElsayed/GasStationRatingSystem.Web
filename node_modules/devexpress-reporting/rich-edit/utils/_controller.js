    ...
    XRRichController.prototype.rtfStringChanged = function (newRtfString) {
        ...
        if (newRtfString === undefined) {
            var openSaveAction = function () {
                _this.richEdit.openDocument(btoa(_this.surface._control.name()), devexpress_richedit_1.DocumentFormat.PlainText, function () {
                    ...
                    rich.executeCommand(devexpress_richedit_1.HomeTabCommandId.ChangeFontName, fontName);
                    rich.executeCommand(devexpress_richedit_1.HomeTabCommandId.ChangeFontSize, fontSize);
                    rich.history.clear();
