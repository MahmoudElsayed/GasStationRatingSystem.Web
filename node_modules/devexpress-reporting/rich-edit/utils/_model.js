...
var XRRichEditControlModel = (function (_super) {
    ...
    function XRRichEditControlModel(element, inlineControl, selected) {
        ...
        _this.disableCommands = [
            devexpress_richedit_1.HomeTabCommandId.Find,
            devexpress_richedit_1.HomeTabCommandId.Replace,
        ];
        ...
        _this._richEdit = devexpress_richedit_1.create(element, _this.createOptions());
    ...
    XRRichEditControlModel.prototype.createOptions = function () {
        var _this = this;
        var options = devexpress_richedit_1.createOptions();
        options.ribbon.visible = false;
        options.view.viewType = devexpress_richedit_1.ViewType.Simple;
    ...
    XRRichEditControlModel.prototype.newDocumentNative = function (onResultReady) {
        ...
        this.executeCommand(enum_1.FileTabCommandId.CreateDocument);
    };
...
var RichLoader = (function (_super) {
    ...
    RichLoader.prototype.load = function (loadData) {
        ...
        if (loadData.dataFormat === xrRichText_1.XRRichTextStreamType.PlainText) {
            formatKey = devexpress_richedit_1.DocumentFormat.PlainText;
        }
            ...
            formatKey = devexpress_richedit_1.DocumentFormat.OpenXml;
        }
...
var RichEditFontModel = (function (_super) {
    ...
    function RichEditFontModel(value, richEdit, foreColor, controller) {
        ...
        for (var _i = 0, _a = [
            [_this.family, function (fontName) { return _this.applyCommand(devexpress_richedit_1.HomeTabCommandId.ChangeFontName, fontName); }],
            [_this.size, function (size) { return _this.applyCommand(devexpress_richedit_1.HomeTabCommandId.ChangeFontSize, size); }],
            [foreColor, function (foreColor) { return _this.applyCommand(devexpress_richedit_1.HomeTabCommandId.ChangeFontForeColor, foreColor); }],
            [_this.modificators.bold, function (bold) { return _this.applyCommand(devexpress_richedit_1.HomeTabCommandId.ToggleFontBold, bold); }],
            [_this.modificators.italic, function (italic) { return _this.applyCommand(devexpress_richedit_1.HomeTabCommandId.ToggleFontItalic, italic); }],
            [_this.modificators.strikeout, function (strikeout) { return _this.applyCommand(devexpress_richedit_1.HomeTabCommandId.ToggleFontStrikeout, strikeout); }],
            [_this.modificators.underline, function (underline) { return _this.applyCommand(devexpress_richedit_1.HomeTabCommandId.ToggleFontUnderline, underline); }],
        ]; _i < _a.length; _i++) {
            var data = _a[_i];
