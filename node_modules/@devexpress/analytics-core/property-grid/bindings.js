...
var $ = require("jquery");
var _svgTemplateEngine_1 = require("./widgets/internal/_svgTemplateEngine");
...
ko.bindingHandlers['dxPropertyGrid'] = {
    init: function (element, valueAccessor, allBindings, viewModel, bindingContext) {
        ...
        var templateHtml = _svgTemplateEngine_1.getTemplate('dx-propertieseditor'), $element = $(element).append(templateHtml);
...
ko.bindingHandlers['lazy'] = {
    init: function (element, valueAccessor, allBindings, viewModel, bindingContext) {
        var resolver = _codeResolver_1.globalResolver;
...
ko.bindingHandlers['dxLocalizedSelectBox'] = {
    init: function (element, valueAccessor, allBindings, viewModel, bindingContext) {
        ...
        options.itemTemplate = function (itemData, itemIndex, itemElement) {
            ...
            var templateHtml = _svgTemplateEngine_1.getTemplate('item-with-title'), $element = $(itemElement).append(templateHtml);
