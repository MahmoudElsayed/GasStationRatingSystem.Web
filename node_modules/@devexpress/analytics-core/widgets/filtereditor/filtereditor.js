...
var _binding_1 = require("../ace/_binding");
...
ko.bindingHandlers['dxFilterEditor'] = {
    init: function (element, valueAccessor) {
        ...
        var templateHtml = _svgTemplateEngine_1.getTemplate('dx-filtereditor'), $element = $(element).append(templateHtml), values = valueAccessor();
...
ko.components.register('dx-filtereditor-plain', {
    ...
    template: _svgTemplateEngine_1.getTemplate('dx-filtereditor-plain')
});
ko.components.register('dx-filtereditor-advanced', {
    ...
    template: _svgTemplateEngine_1.getTemplate('dx-filtereditor-advanced')
});
